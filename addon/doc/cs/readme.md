...
středník : In all languages, you must enter the label of the key located above Tab.
přízvuk-akutní : you must always enter the first key to the left of backspace.
...
Tato stránka byla přeložena z angličtiny do češtiny pomocí Google Translate.
...
* URL: [Kontakt ve francouzštině nebo angličtině](https://www.rptools.org/NVDA-Thunderbird/toContact.html);
* Stáhnout [stabilní verze][1]
* Stáhnout [nejnovější verzi z RPTools.org](https://www.rptools.org/?p=8610)
* Kompatibilita s NVDA: 2019.3 a novější;
* Kompatibilita Thunderbird: verze 102.x;
* [Historie změn na RPTools.org](https://www.rptools.org/NVDA-Thunderbird/changes.php?lg=cs)
...
Tato funkce vám umožňuje například označit zprávu jako důležitou nebo jako úkol. Dále se na liště rychlého filtru zobrazí pouze zprávy s jednou nebo více značkami. Například jsou zobrazeny pouze důležité zprávy v seznamu zpráv;
...
Zobrazí se dialogové okno rozvržení sloupců. Skládá se ze seznamu sloupců a také z tlačítek "Nápověda", "Sloupce" a "Zavřít".
...
### Mluvené klávesové zkratky A, J, M
...
Zvolený typ se uloží do paměti a aktivuje se při příštím zobrazení tohoto dialogu;
...
<!-- Překladatelé : fenêtre de rédaction = Okno zápisu -->
<a name="writeWnd">
## Okno zápisu
...
Přibyly klávesové zkratky, které omezují pohyb ruky.Když je fokus na editačním poli náhradního slova, můžete použít následující klávesové zkratky:
...
<!-- Překladatelé: tato sekce byla přeložena společností Google ve verzi 4.7.1, 8. května 2023 -->
...
Tři přepínače vám umožní vybrat mezi zaměřením na poslední zprávu, první nepřečtenou zprávu v seznamu zpráv nebo složku ve stromovém zobrazení;
...
<!-- Překladatelé: pro jiné jazyky přeložte věty výše do svého jazyka, jako je francouzská tanslace níže.

Interpretace ve français:

Začněte s Inbox - Réglages ;
...
boutonové rádio cliquable non coché :Le dernier message de la liste ;

boutonové rádio non coché cliquable Le dossier Courrier entrant dans l'arborescence des dossiers ;

boutonové rádio coché : Le premier message non lu de la liste ;
-->
...
Tato zkratka je konfigurovatelná pomocí správce vstupních gest NVDA, který nabízí větší svobodu výběru modifikačních kláves než zkratky Windows, omezené na AltGr;
