...
* URL: [Contacto en francés e inglés](https://www.rptools.org/NVDA-Thunderbird/toContact.html);
...
* [Historial de cambios en RPTools.org](https://www.rptools.org/NVDA-Thunderbird/changes.php?lg=es) ;
...
<!-- Translators: ventana de Escribir = Write window -->
<a name="writeWnd">
...
<!-- Translators: para el inglés, poner la sección "Interpretación  en español" en los comentarios para mostrar a otros traductores lo que deben hacer -->
En inglés:
